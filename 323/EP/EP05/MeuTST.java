...
public class MeuTST<Value extends Comparable<Value>> {
    ...
    private static class StringV<Value extends Comparable<Value>> implements Comparable<StringV<Value>> {
   ...
   public Iterable<String> keysWithPrefixByValue(String prefix) {
        ...
        MinPQ<StringV<Value>> queueV = new MinPQ<StringV<Value>>();
        for (String lola : queue) {
            StringV<Value> disney = new StringV<Value>();
        	disney.str = lola;
