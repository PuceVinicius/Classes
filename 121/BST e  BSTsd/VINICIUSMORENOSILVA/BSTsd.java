...
public class BSTsd<Key extends Comparable<Key>, Value> {
    ...
    private int ipl(Node x, int a) {
        if (x.right == null && x.left == null) {
            if (x == root) return 0;
            else return 1;
        }
        if (x.right == null) return a + ipl(x.left, a+1) + 1;
        if (x.left == null) return a + ipl(x.right, a+1) + 1;
        else return a + ipl(x.right, a+1) + ipl(x.left, a+1) + 1;
    }

    public double ipl_ave() {
        double x = ipl();
        double y = size();
        StdOut.println(y);
        return (x/y);
  ...
  /*************************************************************************
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) { 
        ...
        BSTsd<String, Integer> st = new BSTsd<String, Integer>();
        for (int i = 0; !StdIn.isEmpty(); i++) {
            String key = StdIn.readString();
            st.put(key, i);
        }
        StdOut.println(st.ipl_ave());
