...
kernel = cv2.getGaussianKernel(9,10)
kernel = kernel*kernel.T
...
plt.subplot(221),plt.imshow(initial_img, cmap = 'gray')
plt.title('Menino original'), plt.xticks(), plt.yticks([])
plt.subplot(222),plt.imshow(final_img/100000000, cmap = 'gray')
plt.title('Menino sem ruído'), plt.xticks(), plt.yticks([])
