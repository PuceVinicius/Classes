...
constraint "pk_person"
	primary key
constraint "pk_person_check"
	check (cpf_validar(("person_id")::character varying) = 1),
"person_name" varchar(255) not null,
"person_email" varchar(255),
"person_sex" char
constraint "person_sex_check"
	check ("person_sex" = ANY (ARRAY['M'::bpchar, 'H'::bpchar, 'N'::bpchar])),
"person_age" integer
);
